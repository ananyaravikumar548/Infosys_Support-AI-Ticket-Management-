        ...
        <div className="flex flex-col gap-3 sm:flex-row">
          <label className="relative min-w-[280px]">
            ...
            <input
              ...
              placeholder="Search by Jira issue key or ticket ID"
                      ...
                      <div className="flex items-center justify-between gap-3">
                        ...
                        {(log.jira_url || log.jira_link || log.url) && (
                          <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="inline-flex min-h-11 items-center gap-1.5 rounded-lg border border-emerald-800/70 px-2.5 py-1.5 text-[10px] font-semibold text-emerald-300 transition hover:border-emerald-400 hover:bg-emerald-500/10"
                          >
